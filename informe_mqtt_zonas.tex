...
Con el sistema levantado, utilizar un cliente MQTT externo (por ejemplo,
\textbf{MQTT Explorer} o el CLI \texttt{mosquitto\_sub}) para suscribirse
a cada topic individualmente y verificar que los mensajes de cada sensor
llegan al topic correcto. Incluir capturas de pantalla en el informe.

Para suscribirse desde la línea de comandos:
\begin{lstlisting}[style=texto]
mosquitto_sub -h localhost -p 1883 -t "campo/tomate/sensores"
\end{lstlisting}
\end{consigna}
